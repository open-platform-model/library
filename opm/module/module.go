...
// into the opm/module ModuleMetadata projection. The two shapes are
// deliberately identical so this is a copy; the indirection keeps opm/api
// from leaking into opm/module's exported struct field type.
