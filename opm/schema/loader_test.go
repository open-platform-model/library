...
// docs/getting-started.md, AGENTS.md).
...
func TestDefaultSchemaModule_PinsVerifiedRelease(t *testing.T) {
	assert.Equal(t, "opmodel.dev/core@v2.0.0-alpha.10", schema.DefaultSchemaModule)
...
func TestDefaultSchemaVersion_IsTheDefaultModulesVersion(t *testing.T) {
	assert.Equal(t, "v2.0.0-alpha.10", schema.DefaultSchemaVersion())
