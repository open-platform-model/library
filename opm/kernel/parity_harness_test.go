...
var shippedCases = []parityCase{
	{
		...
		Component:          "config",
		Transformer:        shippedCatalogPrefix + "configmap-transformer@2.0.0-alpha.7",
	...
	},
	{
		...
		Instance:           "testdata/parity/instance",
		Component:          "web",
		Transformer:        shippedCatalogPrefix + "deployment-transformer@2.0.0-alpha.7",
		Equality:           equalityOutputFieldsOnly,
		ExpectedDivergence: divergenceContextLabelOrder,
	},
	{
		...
		Instance:    "testdata/parity/instance",
		Component:   "web",
		Transformer: shippedCatalogPrefix + "hpa-transformer@2.0.0-alpha.7",
		Equality:    equalityOutputFieldsOnly,
	},
	{
		...
		Instance:           "testdata/parity/instance",
		Component:          "web",
		Transformer:        shippedCatalogPrefix + "http-route-transformer@2.0.0-alpha.7",
		Equality:           equalityOutputFieldsOnly,
		ExpectedDivergence: divergenceContextLabelOrder,
	},
	{
	...
	},
	{
		...
		Instance:           "testdata/parity/instance",
		Component:          "web",
		Transformer:        shippedCatalogPrefix + "service-transformer@2.0.0-alpha.7",
		Equality:           equalityOutputFieldsOnly,
		ExpectedDivergence: divergenceContextLabelOrder,
	},
}
