// Package core defines the shared primitives of OPM-rendered artifacts.
// Compiled is the kernel's terminal output: Kernel.Render emits *Compiled
// values carrying the rendered CUE value plus OPM provenance.
...
// Compiled is the terminal output of an OPM render. It carries
