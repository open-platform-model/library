...
// Blueprints from the consolidated catalogs/opm v4 line. Drives the render
// flow integration test against the opm_platform fixture (a platform module
// importing opmodel.dev/catalogs/opm).
package web_app
