...
// Config validates values against the schema and returns the merged value or a
// ConfigError with grouped diagnostics. context is used for display ("module");
// name is the release name for display.
//
