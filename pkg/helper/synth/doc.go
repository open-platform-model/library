...
// target API version.
//
// Synth is a peer of pkg/helper/loader, not a subpackage of it. The loader
// tree (pkg/helper/loader/file, pkg/helper/loader/bytes) reads existing
...
//
// Boundary scope: synth helpers live under pkg/helper/ because they are
