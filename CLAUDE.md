...
opm/
  ...
  internal/sourcetree/        Walking, reading, naming and writing a module.Source in both modes: PackageName, OverlayFromDir / OverlayFromFS (.cue files only, cue.mod/module.cue included), SyntheticRoot, WriteTo, ReadFile, Bytes; shared by the kernel's values overlay, the registry loader's staged overlay and the render stage
