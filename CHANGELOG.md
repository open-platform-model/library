...
* **renderer:** simplify render single build ([#23](https://github.com/open-platform-model/library/issues/23)) ([adbe9bc](https://github.com/open-platform-model/library/commit/adbe9bc3be6365522a69d2a701055323f1a9c3d6))
